...
@Component
@Slf4j
public class GroupAuthInterceptor implements HandlerInterceptor {
    @Resource
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        if(handler instanceof HandlerMethod){
            ...
            GroupAuthRequire groupAuthRequire = method.getAnnotation(GroupAuthRequire.class);
            if(groupAuthRequire == null){
                groupAuthRequire = method.getDeclaringClass().getAnnotation(GroupAuthRequire.class);
            }
            if(groupAuthRequire != null){
                ...
                if(userInfo != null){
                    ...
                    if(groupIJoinService.checkIJoinTheGroupOrNot(params)){
                        return true;
                    }
                }
                    //如果权限越界，则拒绝请求
